...
@partial(
    jax.jit,
    static_argnames=("env_obj", "policy_network", "random_actions", "num_belief_particles"),
...
@partial(
    jax.jit,
    static_argnames=(
        "env_obj", "buffer_obj", "policy_network",
        "num_belief_particles", "num_steps", "alpha", "gamma", "tau"
    ),

...
A sequential Monte Carlo algorithm for policy optimization in continuous POMDPs.
...
Their implementations are available in the `baselines` folder.

## Experiments

See the `experiments` folder for the scripts to run the experiments reported in the paper.
